...
if($choose == "4"){
	system("xdg-open https://t.me/agathasangkara");
	die;
	}
...
if($x['isAnonymous'] == false)
	{
		...
		$devicerand = substr(str_shuffle('abcdefghijklmnopqrstuvwxyz0123456789'), 0, 15);
		$linkdevices = activateSamsung($bearer,$linkdevices);
		if(preg_match('/Spotify Premium untuk Samsung/i',$linkdevices)){
		echo "\n$Green ▶ Successfully Claim Offer Samsung Galaxy Series";
		} else {
		echo "\n$Red ▶ 403 Forbidden Validate Samsung Offer"; die;
		}
	}
