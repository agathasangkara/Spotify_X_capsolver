...
function activateSamsung($bearer)
	{
		$url = "https://spclient.wg.spotify.com/premium-destination-hubs/v2/page?locale=id&device_id=8e8d1526eaa9082c&partner_id=&referrer_id=&build_model=Samsung%20galaxy%207edge&cache_key=free&show_unsafe_unpublished_content=false&manufacturer=Samsung";
		$method = "GET";
		$headers = array();
